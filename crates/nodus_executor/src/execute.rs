...
/// A stable equality key for a row, used by set operations and DISTINCT-style
/// dedup. NULLs render to the empty string, so they compare equal — matching the
/// executor's existing render-based row equality.
